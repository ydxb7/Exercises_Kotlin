            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        // call view.findNavController navigate to R.id.action_gameFragment_to_gameWonFragment
                        view.findNavController().navigate(R.id.action_gameFragment_to_gameWonFragment)
                    }
                } else {
                    // Game over! A wrong answer sends us to the gameOverFragment.
                    // TODO (06) Find the navController from the view and navigate to the gameOverFragment
                    // call view.findNavController navigate to R.id.action_gameFragment_to_gameOverFragment
